...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `doctor`(fname, lname, department) VALUES('$firstname', '$lastname', '$department')";
            ...
            <div class="collapse navbar-collapse" id="navigations">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li class="dropdown-item">
                                <a class="nav-link active">Add Doctors</a>
                            </li>
                            <li class="dropdown-item">
            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="input-group pb-3">
                        ...
                        <input type="text" aria-label="Age" class="form-control" name="department">
                    </div>
